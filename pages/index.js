    ...
    <Layout>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <Card title="Simple Weekly Planner" link="#">View Template</Card>
          <Card title="Today's Focus" link="#">View Template</Card>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <Card title="Weather Widget" link="#">Open Widget</Card>
          <Card title="Focus Flow Timer" link="#">Open Widget</Card>
        </div>
      </section>
